...
class OrderModel extends OrderEntity {
  ...
  factory OrderModel.fromSnapShot(
    ...
    return OrderModel(
      ...
      placerUid: documentSnapshot.data()!['placerUid'],
      receiverUid: documentSnapshot.data()!['receiverUid'],
  ...
  factory OrderModel.fromEntity(OrderEntity orderEntity) => OrderModel(
        ...
        placerUid: orderEntity.placerUid,
        receiverUid: orderEntity.receiverUid,
